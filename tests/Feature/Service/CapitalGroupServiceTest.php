...
class CapitalGroupServiceTest extends ServiceTestCase
{
    ...
    public function test_service_call_read_when_user_have_capital_groups_read_with_empty_search()
    {
    ...
    public function test_service_call_read_when_user_have_capital_groups_with_special_char_in_search()
    {
        $companyId = Company::inRandomOrder()->first()->id;
        $search = " !#$%&'()*+,-./:;<=>?@[\]^_`{|}~";
        $paginate = true;
